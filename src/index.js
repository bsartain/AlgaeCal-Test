...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const api = fetch('https://www.algaecal.com/wp-json/acf/v3/options/options').then(res => res.json());
...
const padNumber = number => ((number.toString().length < 2) ? (`0${number}`) : number);
...
wistiaVideoContainer.addEventListener('click', () => {
